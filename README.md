...
that stall torques are not achieved on any servos. The ROBOTIS form factors for the servos are all 430mm except for the base 
servo which is 540mm. The overall reach of the arm is now ~655mm, but this can be adjusted by varying the length of the links 
...
being experienced by the links on the arm.
