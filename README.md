...
gaining an understanding of how the torque applied to the servo on the end effector translates to a certain value of gripping force. All parts for the end efffector have been manufactured and are assembled, once the load cells are calibrated we can begin testing this subsystem.

![image](https://github.com/user-attachments/assets/e1be57f4-ba42-4512-953b-e409a29aee1d)

End Effector parts that were manufactured.
